    ...
    <div class="row align-items-center py-3 px-xl-5">
        ...
        <div class="col-lg-3 col-6 text-right">
            ...
            <a href="{{route('shop-cart')}}" class="btn border">
                ...
                <span class="badge">{{cart_add()}}</span>
            </a>
        </div>
    </div>
</div>
...
<div class="container-fluid mb-5">
    <div class="row border-top px-xl-5">
        {{--
            this [if] for show the slider of categories if in home page then slider will show as open
            if not in the home page the silder collapse
        --}}
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="{{route('shop-cart')}}" class="dropdown-item">Shopping Cart</a>
                    ...
                    @if(isset(auth()->guard('customer')->user()->name))
                        <div class="navbar-nav ml-auto py-0">
                            <a class="nav-item nav-link">{{auth()->guard('customer')->user()->name}}</a>
                            <a href="{{route('page.logout',auth()->guard('customer')->user()->id)}}" class="nav-item nav-link">Logout</a>
                        </div>
                    @else
                    <div class="navbar-nav ml-auto py-0">
                        <a href="{{route('page.login')}}" class="nav-item nav-link">Login</a>
                        <a href="{{route('page.register')}}" class="nav-item nav-link">Register</a>
                    </div>
                        @endif
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 410px;">
                        <img class="img-fluid" src="{{asset('assets/front/img/carousel-1.jpg')}}" alt="Image">
                    ...
                    <div class="carousel-item" style="height: 410px;">
                        <img class="img-fluid" src="{{asset('assets/front/img/carousel-2.jpg')}}" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
